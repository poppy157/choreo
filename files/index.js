...
const UUID = process.env.UUID || '3fe52e3b-c0d2-46bf-a49b-b70222f83e3b'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo1.ngfbrtgbdfvs.tk';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZjlhMTcxMDc1MzU5Zjk2NTFmYzkxMmU2M2QyZTg5OWIiLCJ0IjoiZmFkODczZDItNDgwYS00MjNlLTk4OTUtZTFjZTBiMDYzODc3IiwicyI6Ik56ZzJNRGMzWW1VdFlqVTJNQzAwWm1RM0xUZ3lOemN0TkRreFpXWXhPVEpsWkRJeCJ9';
